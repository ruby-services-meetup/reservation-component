# -*- encoding: utf-8 -*-
# stub: evt-set_attributes 0.3.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "evt-set_attributes".freeze
  s.version = "0.3.0.2"
  ...
  s.homepage = "https://github.com/eventide-project/set-attributes".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3.3".freeze)
  s.rubygems_version = "2.6.11".freeze
  s.summary = "Set an object's attributes from a hash or an object that implements to_h".freeze

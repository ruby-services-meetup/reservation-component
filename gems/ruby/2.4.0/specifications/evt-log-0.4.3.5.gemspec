# -*- encoding: utf-8 -*-
# stub: evt-log 0.4.3.5 ruby lib

Gem::Specification.new do |s|
  s.name = "evt-log".freeze
  s.version = "0.4.3.5"
  ...
  s.homepage = "https://github.com/eventide-project/log".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3.3".freeze)
  s.rubygems_version = "2.6.11".freeze
  s.summary = "Logging to STD IO with levels, tagging, and coloring".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<terminal_colors>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<terminal_colors>.freeze, [">= 0"])

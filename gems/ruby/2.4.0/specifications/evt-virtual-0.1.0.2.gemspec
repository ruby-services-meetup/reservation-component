# -*- encoding: utf-8 -*-
# stub: evt-virtual 0.1.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "evt-virtual".freeze
  s.version = "0.1.0.2"
  ...
  s.homepage = "https://github.com/eventide-project/virtual".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3.3".freeze)
  s.rubygems_version = "2.6.11".freeze
  s.summary = "Virtual method declaration".freeze

# -*- encoding: utf-8 -*-
# stub: evt-settings 0.2.0.5 ruby lib

Gem::Specification.new do |s|
  s.name = "evt-settings".freeze
  s.version = "0.2.0.5"
  ...
  s.summary = "Settings data access and assignment".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<confstruct>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<confstruct>.freeze, [">= 0"])
